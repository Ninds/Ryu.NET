...
namespace GenerateTestData
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                var filenames = new string[] { "print64minus.txt", "print64plus.txt" };

                using (var outputFile = new StreamWriter(Path.Combine("..", "..", "..", "..", "..", "Ryu.Net.s2d_data", "SmallD2STestSet.cs")))
                {
                    outputFile.WriteLine(
@$"namespace RyuDotNet.UnitTests.s2d_data
{{
     public static class SmallD2STestSet
     {{
           
            public  static double[] TestArray =  new double[]
            {{
